CREATE OR ALTER PROCEDURE CITA_PRIMERA_VEZ (P_CLIENTE_ID INTEGER)
 RETURNS (R_CLIENTE_ID INTEGER, R_PRIMERA_VEZ INTEGER, R_FECHA_INICIAL DATE, R_USUARIO_RESPONSABLE VARCHAR(200))
...
BEGIN
  ...
  ON EXTERNAL DATA SOURCE path_bd_zeus
   ...
   PASSWORD password
   INTO
     :R_CLIENTE_ID, :R_PRIMERA_VEZ, :R_FECHA_INICIAL, :R_USUARIO_RESPONSABLE;
